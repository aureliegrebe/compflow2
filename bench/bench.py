...
if __name__ == "__main__":
    ...
    a.loglog(N, dt_cf2, "b-", label="compflow")
    a.loglog(N, dt_cf, "g-", label="compflow2")
    a.loglog(N, dt_min_pgf, "r:", label="pgf min")
    a.loglog(N, dt_min_cf2, "b:", label="compflow min")
    a.loglog(N, dt_min_cf, "g:", label="compflow2 min")
